...
public class TestOceanBase {
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        // String url = "jdbc:oceanbase://49.52.27.61:2881/test";
        // String username = "root@test";
        // String password = "1234"; //密码
//        String url = "jdbc:oceanbase://49.52.27.61:2881/test?user=root@test&password=1234";
//        Class.forName("com.alipay.oceanbase.jdbc.Driver"); // 驱动类名
        ...
        // stmt.executeLargeUpdate("CREATE TABLE table18_0(id VARCHAR(100) PRIMARY KEY,
        // value VARCHAR(100));", 1);
        ...
        // sp = con.setSavepoint();
        //
        // stmt = con.prepareStatement("INSERT INTO table18_0 VALUES(?, ?);", 1005,
        // 1008, 2);
        // con.setAutoCommit(true);
        // stmt.closeOnCompletion();
        //
        // stmt = con.createStatement(1003, 1007, 2);
        // stmt.addBatch("DELETE FROM table18_0 WHERE (table18_0.id <> 'test') AND
        // (table18_0.value = 'test');");
        // stmt.addBatch("UPDATE table18_0 SET value = 'updated' WHERE (table18_0.id !=
        // 'test') OR (table18_0.value >= 'test');");
        // stmt.addBatch("DELETE FROM table18_0 WHERE (table18_0.id >= 'test');");
        // stmt.executeLargeBatch();
        //
        // stmt = con.prepareStatement("SELECT table18_0.value FROM table18_0 WHERE
        // table18_0.value = ?", 1005, 1007, 1);
        ...
        // stmt.setFetchSize(1000000000);
        // stmt.executeLargeUpdate("UPDATE table18_0 SET value = 'updated' WHERE
        // (table18_0.id = 'test');", 1);
        //
        ...
        // rs.previous();
        //
        // rs = stmt.executeQuery("SELECT id, value FROM table18_0 WHERE
        // (table18_0.value != 'test');");
        // con.commit();
        // rs.next();
        ...
        // rs.isFirst();
        // con.rollback();
        // rs = stmt.executeQuery("SELECT id, value FROM table18_0 WHERE (table18_0.id
        // <= 'test') OR (table18_0.id <> 'test');");
        ...
        // System.out.println(stmt.executeLargeUpdate("CREATE TABLE table18_0(id
        // VARCHAR(100) PRIMARY KEY,value VARCHAR(5));", 2));
        // sp = con.setSavepoint();
        // System.out.println(stmt.getResultSetType());
        // rs = stmt.executeQuery("SELECT id, value FROM table18_0 WHERE
        // (table18_0.value <= ')XfeUrXwE;!B21');");
        ...
        // }
        // rs = stmt.executeQuery("SELECT id, value FROM table18_0 WHERE (table18_0.id =
        // 'Rq4,cM7KOs^A,u0%dGt0@E9EqZI)8VFUkeZIXCoXp)4'-'P)ab2bh4u') OR (table18_0.id
        // !=
        // 'wWc#;8g4;IjtMhC5m^@5x7MJywO'-'^0T1m%7&hDTcwj,d4m3uXpFsfMGS0Pj22!TT9!^');");
        // System.out.println(rs.isAfterLast());
        // System.out.println(stmt.executeLargeUpdate("INSERT INTO table18_0
        // VALUES('4K5R)1hRxv@$ogZU@BmF9W.TX67cjy!,b', 'QlUvr')", 1));
        //
        ...
        // }
        // System.out.println(stmt.getUpdateCount());
        // System.out.println(stmt.executeUpdate("DELETE FROM table18_0 WHERE
        // (table18_0.id = '7p*tAXx^VID') AND (table18_0.value = ',5HbF%2;8*3EOfV');",
        // 1));
        // try {
        // rs.updateRow();
        // } catch (Exception e) {
        ...
        // con.rollback(sp);
        // rs = stmt.executeQuery("SELECT id, value FROM table18_0 WHERE (table18_0.id
        // >= 'DIXu$Ey$NWU2gXg0qPFln');");
        // System.out.println(rs.next());
        // System.out.println(rs.isLast());
        // System.out.println(stmt.executeUpdate("DELETE FROM table18_0 WHERE
        // (table18_0.id != 'C5dnbcIWzmcttXnSnUboXvz2EVckiStEf7OEA') AND
        // (table18_0.value > 'kpTgyYU(RcZ)GOmmVHie');", 2));
        // try {
        ...
        // System.out.println(stmt.executeLargeUpdate("UPDATE table18_0 SET value =
        // '^*uew.a#&ueZ5m;5VxxknFd77M62YFnroAfHY' WHERE (table18_0.id <
        // 'Uq$VtbVcMtKj5J$%ptpg)d5$dkqs2HRg^9a^4,3nE&');", 1));
        // try {
        // rs.updateRow();
        // } catch (Exception e) {
        // System.out.println(e);
        ...
        stmt.executeUpdate("DROP TABLE IF EXISTS table18_0;");
        System.out
                .println(stmt.executeLargeUpdate("CREATE TABLE table18_0(id SMALLINT PRIMARY KEY,value TINYINT);", 1));
        System.out.println(stmt.executeLargeUpdate(
                "UPDATE table18_0 SET value = 446748952 WHERE (table18_0.value > -628126433/-1075983817);", 2));
        System.out.println(stmt.getResultSetType());
        try {
        ...
        rs = stmt.executeQuery(
                "SELECT id, value FROM table18_0 WHERE (table18_0.value > -431675329-1315731580-257152969) OR (table18_0.id != 936751358);");
        try {
            con.commit();
        } catch (Exception e) {
            System.out.println(e);
        ...
        rs = stmt.executeQuery(
                "SELECT id, value FROM table18_0 WHERE (table18_0.id != -275616731) OR (table18_0.value = -132209959);");
        sp = con.setSavepoint();
        ...
        System.out.println(stmt.getResultSetConcurrency());
        rs = stmt.executeQuery(
                "SELECT id, value FROM table18_0 WHERE (table18_0.id != 795770810*-2070864731*1430613002) OR (table18_0.value = -592844164);");
        System.out.println(stmt.getResultSetConcurrency());
        System.out.println(rs.next());
        ...
        rs.beforeFirst();
        System.out.println(stmt.executeLargeUpdate(
                "UPDATE table18_0 SET value = 1128998489 WHERE (table18_0.value = -693768693);", 1));
        try {
            con.rollback();
        } catch (Exception e) {
            System.out.println(e);
        ...
        System.out.println(stmt.executeUpdate(
                "UPDATE table18_0 SET value = 217126606 WHERE (table18_0.value <= 1179528556) OR (table18_0.value != 4606564);",
                2));
        try {
